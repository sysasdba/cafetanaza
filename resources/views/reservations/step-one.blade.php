                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full"
                            src="https://cdn.pixabay.com/photo/2017/07/26/21/14/spilled-coffee-2543133_1280.jpg" alt="img" />
                    </div>
                        ...
                        <div class="w-full">
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="first_name" name="first_name" maxlength="15"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="last_name" name="last_name" maxlength="15"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="tel_number" name="tel_number" maxlength="13"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="number" id="guest_number" name="guest_number" min="10" max="40"
